...
export function RecommendationShelf({ character = 'discovery', title = 'В вашей частоте' }: { character?: string; title?: string }) {
  ...
  return <section className="discovery-shelf">
    <div className="section-heading"><div><span className="eyebrow">СОБРАНО ДЛЯ ВАС</span><h2>{title}</h2></div>
