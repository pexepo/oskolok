...
import {ArrowDownToLine,Link2,Upload,Check,Loader2} from 'lucide-react';
...
export function ImportPage(){
 ...
 {busy&&<p role="status" className="import-status"><Loader2 className="animate-spin" size={18}/> Подготавливаем коллекцию… {progress}</p>}{error&&<p role="alert" className="lyrics-error">{error}</p>}
