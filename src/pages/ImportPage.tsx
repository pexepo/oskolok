...
export function ImportPage(){
 ...
 {busy&&<p role="status" className="import-status"><UniqueLoading size="sm" label="Подготавливаем коллекцию"/> Подготавливаем коллекцию… {progress}</p>}{error&&<p role="alert" className="lyrics-error">{error}</p>}
