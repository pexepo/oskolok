...
export function ArtistPage(){
 ...
 if(detail.isPending)return <LoadingState className="route-loading" label="Собираем портрет исполнителя…"/>;
